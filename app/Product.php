...
{
	protected $fillable = ['product_sub_category_id', 'product_sub_category_name', 'name', 'model', 'description', 'package_unit', 'weight', 'weight_unit', 'price', 'brand', 'inventory', 'sort_order','thumbnail_url', 'off_shelf'];
